	...
	# Generation started: Mon Jun 08 14:12:40 GMT 2026
	#
...
test_7:
	...
	li sp, 0xffffffffffff8000
	mul t5, ra, sp
	li t4, 0x400000000000
	li gp, 0x7
	bne t5, t4, fail
test_30:
	li ra, 0xaaaaaaaaaaaaaaab
	li sp, 0x2fe7d
	mul t5, ra, sp
	li t4, 0xff7f
	li gp, 0x1e
...
test_29:
	...
	#==================================================================================================
	# Epilogue (riscv_test_macros.rb:884)
